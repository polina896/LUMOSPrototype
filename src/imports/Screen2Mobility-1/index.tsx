...
function Paragraph() {
  return (
    <div className="[word-break:break-word] font-['Jua','Noto_Sans:Regular',sans-serif] h-[27px] leading-[0] relative shrink-0 w-[328.81px]" data-name="Paragraph">
...
function Background() {
  return (
    <div className="absolute bg-[#e7f3ec] content-stretch flex items-center left-[50.81px] px-[6px] py-[2px] rounded-[999px] top-[6px]" data-name="Background">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans_Symbols2:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2f7d4f] text-[10px] whitespace-nowrap">
  ...
  return (
    <div className="h-[25px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-0 not-italic text-[#1a1a1a] text-[21px] top-[11.5px] w-[43.131px]">
...
function Background1() {
  return (
    <div className="absolute bg-[#f3f3f1] content-stretch flex items-center left-[58.88px] px-[6px] py-[2px] rounded-[999px] top-[6px]" data-name="Background">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container7() {
  return (
    <div className="h-[25px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-0 not-italic text-[#1a1a1a] text-[21px] top-[11.5px] w-[51.157px]">
...
function Background2() {
  return (
    <div className="absolute bg-[#f1e9ff] content-stretch flex items-center left-[58.11px] px-[7px] py-[2px] rounded-[999px] top-[6px]" data-name="Background">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b3c72] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container9() {
  return (
    <div className="h-[25px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-0 not-italic text-[#1a1a1a] text-[21px] top-[11.5px] w-[51.143px]">
...
function Container12() {
  return (
    <div className="h-[25px] relative shrink-0 w-full" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-0 not-italic text-[#1a1a1a] text-[21px] top-[11.5px] w-[41.12px]">
...
function BackgroundBorder5() {
  return (
    <div className="-translate-y-1/2 absolute bg-white content-stretch flex gap-[9px] items-center left-0 px-[13px] py-[8px] rounded-[10px] top-[calc(50%+6.5px)]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#e5e5e2] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container17 />
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#1a1a1a] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Svg7 />
        <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b3c72] text-[10px] tracking-[1.2px] uppercase whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
  ...
  return (
    <div className="max-w-[652.3930053710938px] relative shrink-0 w-[652.39px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] pb-[7.795px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
          <p className="mb-0">
            <span className="leading-[20.8px]">{`Home origins concentrate in `}</span>
            <span className="[word-break:break-word] font-['Jua','Noto_Sans:Regular',sans-serif] leading-[20.8px] text-[#1a1a1a]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container30() {
  return (
    <div className="content-stretch flex items-baseline relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b3c72] text-[18px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container45() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular','Noto_Sans_Symbols:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#9a9a9a] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container48() {
  return (
    <div className="absolute content-stretch flex flex-col inset-[43.06%_40.51%_49.44%_49%] items-start" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-[rgba(255,255,255,0.45)] tracking-[0.4px] whitespace-nowrap">
...
function Margin2() {
  return (
    <div className="content-stretch flex flex-col items-start py-px relative shrink-0" data-name="Margin">
      <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[8px] text-[rgba(255,255,255,0.55)] whitespace-nowrap">
...
function Background6() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.94)] bottom-[9px] content-stretch flex flex-col items-start px-[8px] py-[4px] right-[8.48px] rounded-[7px]" data-name="Background">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular','Noto_Sans_Symbols:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
        <p>
          <span className="leading-[15px]">{`Hover 308xxx → `}</span>
          <span className="[word-break:break-word] font-['Jua','Noto_Sans:Regular','Noto_Sans_Symbols:Regular',sans-serif] leading-[15px] text-[#1a1a1a]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#9a9a9a] text-[10px] tracking-[1px] uppercase w-full">
...
function Container55() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b3c72] text-[12px] text-right whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function TakeawayBullet1() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="point">
      <div className="font-['Jua',sans-serif] leading-[18.6px] text-[#6b3c72] text-[12px] shrink-0">•</div>
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#1a1a1a] text-[12px] w-full" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function SegPill({ label, active, onClick }: { label: string; active: boolean; onClick?: () => void }) {
  return (
    ...
    >
      <span className={`font-['Jua',sans-serif] text-[12px] leading-[16px] whitespace-nowrap ${active ? 'text-[#6b3c72]' : 'text-[#6b6b6b]'}`}>{label}</span>
    </button>
  );
}
  ...
  return (
    <div className="bg-[#23262f] col-1 h-[200px] justify-self-stretch relative rounded-[10px] row-1 shrink-0" data-name="Background+Border">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        ...
        <div className="absolute left-[10px] top-[8px] font-['Jua',sans-serif] text-[9.5px] tracking-[0.6px] uppercase text-[rgba(255,255,255,0.5)] leading-[15px]">{caption}</div>
        <div className="absolute content-stretch flex flex-col inset-[43.06%_40.51%_49.44%_49%] items-start">
          <div className="font-['Jua',sans-serif] text-[10px] text-[rgba(255,255,255,0.45)] tracking-[0.4px] leading-[15px] whitespace-nowrap">SINGAPORE</div>
        </div>
        <div className="absolute content-stretch flex flex-col items-center right-[8.19px] top-[9px]">
          <div className="font-['Jua',sans-serif] text-[8px] text-[rgba(255,255,255,0.55)] leading-[12px] py-px">High</div>
          ...
          <div className="font-['Jua',sans-serif] text-[8px] text-[rgba(255,255,255,0.55)] leading-[12px] py-px">Low</div>
        </div>
        <div className="absolute bg-[rgba(255,255,255,0.94)] bottom-[9px] flex flex-col items-start px-[8px] py-[4px] right-[8.48px] rounded-[7px]">
          <p className="font-['Jua',sans-serif] text-[10px] text-[#6b6b6b] leading-[15px] whitespace-nowrap">
...
function Postcodes({ view }: { view: GeoView }) {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start col-2 justify-self-stretch row-1 self-start shrink-0 pt-[2px]" data-name="Top postcodes">
      <div className="font-['Jua',sans-serif] text-[10px] tracking-[1px] uppercase text-[#9a9a9a] leading-[15px] w-full">{view.postLabel}</div>
      {view.postcodes.map((p, i) => (
        <div key={p.code + p.place} className="grid grid-cols-[120px_minmax(0,1fr)_48px] gap-[10px] items-center w-full">
          <div className="overflow-clip">
            <p className="font-['Jua',sans-serif] text-[12px] text-[#1a1a1a] leading-[18px] whitespace-nowrap">{`${p.code} ${p.place}`}</p>
          </div>
          ...
          <div className="text-right">
            <p className="font-['Jua',sans-serif] text-[12px] text-[#6b3c72] leading-[18px] whitespace-nowrap">{p.idx}</p>
          </div>
        </div>
      ))}
    </div>
...
function Container77() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#9a9a9a] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
  ...
  return (
    <div className="h-[110px] relative shrink-0 w-full" data-name="SVG">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        ...
        <p className="[word-break:break-word] absolute font-['Jua',sans-serif] inset-[10.91%_71.98%_80%_17.47%] leading-[normal] not-italic text-[#9a9a9a] text-[8px]">90th pct (km)</p>
        ...
        <p className="[word-break:break-word] absolute font-['Jua',sans-serif] inset-[47.27%_18.57%_43.64%_73.74%] leading-[normal] not-italic text-[#6b3c72] text-[8px]">14.2km med</p>
        ...
        <p className="[word-break:break-word] absolute font-['Jua',sans-serif] inset-[16.36%_20.11%_74.55%_75.93%] leading-[normal] not-italic text-[#6b6b6b] text-[8px]">52km</p>
        <p className="[word-break:break-word] absolute font-['Jua',sans-serif] inset-[84.55%_80.33%_7.27%_17.03%] leading-[normal] not-italic text-[#9a9a9a] text-[7px]">Oct</p>
        <p className="[word-break:break-word] absolute font-['Jua',sans-serif] inset-[84.55%_18.57%_7.27%_78.57%] leading-[normal] not-italic text-[#9a9a9a] text-[7px]">May</p>
      </div>
    </div>
  );
}
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[12px] w-full">
          <p className="mb-0">
            ...
            <span className="[word-break:break-word] font-['Jua',sans-serif] leading-[18.6px] not-italic text-[#6b3c72]">14.2km</span>
            <span className="leading-[18.6px]">{`, with the `}</span>
            <span className="[word-break:break-word] font-['Jua',sans-serif] leading-[18.6px] not-italic text-[#6b3c72]">90th percentile</span>
          </p>
          <p>
            <span className="leading-[18.6px]">{`extending to `}</span>
            <span className="[word-break:break-word] font-['Jua',sans-serif] leading-[18.6px] not-italic text-[#6b3c72]">52km</span>
...
function Background13() {
  return (
    <div className="absolute bg-[#f1e9ff] h-[11px] left-[138.22px] rounded-[5px] top-[5.22px] w-[87.09px]" data-name="Background">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-[6px] not-italic text-[#6b3c72] text-[9px] top-[5.5px] tracking-[0.36px] w-[75.118px]">
...
function Container84() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Container">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua',sans-serif] justify-center leading-[0] left-0 not-italic text-[#1a1a1a] text-[14px] top-[10px] w-[131.117px]">
    ...
    <div className="absolute bg-[rgba(255,255,255,0.94)] bottom-[9px] content-stretch flex flex-col items-start px-[8px] py-[4px] right-[9.5px] rounded-[7px]" data-name="Background">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
        <p>
          ...
          <span className="[word-break:break-word] font-['Jua','Noto_Sans:Regular',sans-serif] leading-[15px] text-[#1a1a1a]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Margin7() {
  return (
    <div className="content-stretch flex flex-col items-start py-[4px] relative shrink-0" data-name="Margin">
      <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[18px] whitespace-nowrap">
...
function Container91() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[14px] w-full">
...
function Container99() {
  return (
    <div className="col-3 content-stretch flex h-[18px] items-center justify-end justify-self-stretch relative row-1 self-center shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[12px] text-right whitespace-nowrap" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container102() {
  return (
    <div className="col-3 content-stretch flex h-[18px] items-center justify-end justify-self-stretch relative row-1 self-center shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Jua',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b6b6b] text-[12px] text-right whitespace-nowrap">
...
function Container112() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] left-[14px] text-[#6b6b6b] text-[11px] top-[7.5px] w-[69.113px]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container113() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] left-[14px] text-[#6b6b6b] text-[11px] top-[7.5px] w-[79.122px]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
...
function Container114() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Jua','Noto_Sans:Regular',sans-serif] justify-center leading-[0] left-[14px] text-[#6b6b6b] text-[11px] top-[7.5px] w-[55.177px]" style={{ fontVariationSettings: '"CTGR" 0, "wdth" 100, "wght" 400' }}>
