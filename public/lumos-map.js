...
(function (global) {
  ...
  var state={ focus:null, layers:{density:true,poi:false,media:false,movement:false}, mv:'flow', densityOp:0.60, signal:'Residential', hour:8, auds:['stockup','value','bulk'], filters:{time:null,freq:null,demo:[]} };
  ...
  function boot(){
    ...
    renderLayers(); map.on('zoomend',updateGran); updateGran(); wire();
      ...
      return {
        ...
        clearFocus: function(){ state.focus=null; drawRing(null); renderLayers(); setMovementLabel(); },
