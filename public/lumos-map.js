...
(function (global) {
  ...
  function buildInbound(){
    ...
    cm.trips.forEach(function(t){
      var pts=curve(t.c,anchor,0.13,30), w=1.6+t.pct*0.16;
  ...
  function xBefore(rg){
    ...
    for(var i=0;i<stops.length-1;i++){
      var pts=curve(stops[i].c,stops[i+1].c,0.10,24);
  ...
  function xSwitch(rg){
    ...
    COMPETITORS.forEach(function(cp){
      var c=[anchor[0]+cp.d[0], anchor[1]+cp.d[1]], pts=curve(c,anchor,0.16,26);
